...
@dataclass(frozen=True)
class SpeakerClusterRunRefPort(Port):
    TYPE_NAME = "SPEAKER_CLUSTER_RUN_REF"
    python_type = SpeakerClusterRunRef
    color = "#0F766E"
    description = "Completed speaker clustering run reference"
