...
def sample_flow_training_case(
    ...
    zero_time_count = int(batch_size * config.zero_time_ratio)
    uniform_time_count = flow_matching_count - zero_time_count
    ...
    first = _uniform_time(trajectory_count, latent, generator)
    second = _uniform_time(trajectory_count, latent, generator)
