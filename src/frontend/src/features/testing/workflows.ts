...
const SINGLE_EDGES: WorkflowEdge[] = [
  ...
  { source_node: "checkpoint", source_port: "checkpoint", target_node: "synthesis", target_port: "checkpoint" },
...
const SWEEP_EDGES: WorkflowEdge[] = [
  ...
  { source_node: "checkpoint", source_port: "checkpoint", target_node: "sweep_synthesis", target_port: "checkpoint" },
