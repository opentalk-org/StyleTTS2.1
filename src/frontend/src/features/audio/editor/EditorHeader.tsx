...
import { useRenameAudioFileMutation, useUpdateAudioLanguageMutation, useUpdateAudioScoreMutation } from "../query";
    ...
    <>
      ...
      {showMetadata ? (
        <div className="mb-4 overflow-hidden rounded-[10px] border border-line bg-panel">
          ...
          <pre className="max-h-[260px] overflow-auto bg-bg p-4 font-mono text-[11px] leading-relaxed text-txt-dim">{metadataJson}</pre>
        </div>
      ) : null}
    </>
  );
