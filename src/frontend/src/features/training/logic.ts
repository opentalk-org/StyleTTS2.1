...
const STYLE_TTS_NODES = [
  ...
  { id: "dataset", type: "TrainingDatasetInput", x: 64, y: 220 },
  { id: "audio_ids", type: "ListDatasetAudioIds", x: 330, y: 220 },
  { id: "base_checkpoint", type: "CheckpointAssetInput", x: 64, y: 420 },
  { id: "prefetch_checkpoint", type: "PrefetchCheckpointAsset", x: 330, y: 420 },
  { id: "assets", type: "OptionalTrainingAssetsInput", x: 64, y: 620 },
  { id: "prefetch_assets", type: "PrefetchTrainingAssets", x: 330, y: 620 },
  { id: "alphabet", type: "PhonemeAlphabetInput", x: 64, y: 820 },
  { id: "fetch_alphabet", type: "FetchPhonemeAlphabet", x: 330, y: 820 },
  { id: "ood_sets", type: "OodTextSetInput", x: 64, y: 1020 },
...
const STYLE_TTS_EDGES: WorkflowEdge[] = [
  ...
  { source_node: "dataset", source_port: "dataset", target_node: "audio_ids", target_port: "dataset" },
  ...
  { source_node: "alphabet", source_port: "alphabet_ref", target_node: "fetch_alphabet", target_port: "alphabet_ref" },
  { source_node: "fetch_alphabet", source_port: "alphabet", target_node: "styletts", target_port: "phoneme_alphabet" },
...
const F0_NODES = [
  ...
  { id: "dataset", type: "TrainingDatasetInput", x: 64, y: 220 },
  { id: "audio_ids", type: "ListDatasetAudioIds", x: 330, y: 220 },
  { id: "pretrained", type: "CheckpointAssetInput", x: 64, y: 420 },
  { id: "prefetch_checkpoint", type: "PrefetchCheckpointAsset", x: 330, y: 420 },
...
const ASR_NODES = [
  ...
  { id: "pretrained", type: "CheckpointAssetInput", x: 64, y: 420 },
  { id: "prefetch_checkpoint", type: "PrefetchCheckpointAsset", x: 330, y: 420 },
  { id: "alphabet", type: "PhonemeAlphabetInput", x: 64, y: 620 },
  { id: "fetch_alphabet", type: "FetchPhonemeAlphabet", x: 330, y: 620 },
...
const ASR_EDGES: WorkflowEdge[] = [
  ...
  { source_node: "alphabet", source_port: "alphabet_ref", target_node: "fetch_alphabet", target_port: "alphabet_ref" },
  { source_node: "fetch_alphabet", source_port: "alphabet", target_node: "asr", target_port: "phoneme_alphabet" },
];
