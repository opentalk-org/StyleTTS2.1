...
class Generator(torch.nn.Module):
    ...
    def forward(self, x):  # 55.017 GFLOPs/s total at 24 kHz/hop 300; batch dimension excluded.
        ...
        f0 = self.f0_upsamp(f0[:, None]).transpose(1, 2)  # 0.000 GFLOPs/s; nearest-neighbor copy and view.
        ...
        har_spec, har_phase = self.stft.transform(har_source)  # ~0.002 GFLOPs/s FFT; abs/angle transcendental ops excluded.
        ...
        for i in range(self.num_upsamples):  # 0.000 GFLOPs/s; stages i=0,1.
            ...
            for j in range(self.num_kernels):  # Resblocks by stage: 1.887, 4.404, 6.921; 2.832, 6.607, 10.383 GFLOPs/s.
