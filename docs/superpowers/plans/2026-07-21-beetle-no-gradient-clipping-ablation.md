...
- Change only both optimizer `maximum_gradient_norm` values from `10.0` to `1.0e30`.
...
- Produces: a valid Stage 1 configuration with generator and discriminator maximum gradient norms set to `1.0e30`.
...
```yaml
generator_optimizer:
  maximum_gradient_norm: 1.0e30
discriminator_optimizer:
  maximum_gradient_norm: 1.0e30
```

- [ ] **Step 2: Validate configuration equivalence**
...
- [ ] **Step 3: Validate through the project configuration loader**
...
- [ ] **Step 1: Confirm the baseline boundary**
...
- [ ] **Step 3: Check no-clipping metrics**
